            ...
            <div class="container">
                <form class="form-horizontal" role="form" enctype="multipart/form-data" action="addbook.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" minlength="12" maxlength="12"   title="12 digit ISBN number"    title="Please enter valid phone number"  class="form-control" name="label" placeholder="Enter ISBN" id="password" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <select custom-select custom-select-lg name="select" required>
                            <option>SELECT</option>
                            <option>Advance Operating System</option>
                            <option>Mobile Technology</option>
                            <option>Software Project Manegment</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" pattern="[6789][0-9]{9}"  title="Please enter valid phone number" class="form-control" name="call" placeholder="Enter Phone number" id="password" required>
